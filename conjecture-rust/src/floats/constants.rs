// Constants and basic types for float generation
...
pub const REVERSE_BITS_TABLE: [u8; 256] = [
...
// Maximum bits for simple integer encoding
pub const SIMPLE_THRESHOLD_BITS: u32 = 56;
